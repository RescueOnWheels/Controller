...
var platforms = {
    win32: function(dev) {
        var isWired = dev.productId == wired_product_id;
        var isWireless = dev.productId == product_id;

        return (isWired && dev.path.includes('&mi_01') || (isWireless && dev.path.includes('&mi_02')));
    },
    darwin: function(dev) {
